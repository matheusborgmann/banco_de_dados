...
/*a) Inserir no mínimo, 3 linhas e cada uma das tabelas acima. Apresentar os scripts de inserção. */
...
/*b) Obtenha os nomes das disciplinas que possuem mais de três créditos.*/
SELECT * FROM Disciplina WHERE CreditosDisc > 3;
/*c) Obtenha os códigos dos professores que ministraram aulas em 2002/2./	
...
/*i) Obtenha os números das salas do prédio "LABORATÓRIOS". */
...
/*k) Obtenha os códigos dos professores que não possuem turma em 2002/2.
*/
SELECT CodProf FROM ProfTurma WHERE AnoSem NOT IN ('2002/2');
/*l) Nomes dos departamentos que possuem disciplinas que não apresentam pré-requisito.

*/	
/*m) Obtenha os códigos dos professores que ministraram aulas em 2002/1 e 2002/2.
*/ 
SELECT CodProf FROM ProfTurma WHERE AnoSem = '2002/2' or AnoSem = '2002/1';
/*n) Obtenha os nomes dos departamentos em que há pelo menos uma disciplina com mais que três créditos.*/
